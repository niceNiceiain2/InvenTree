...
//            sku = new String();
//        }
//        List<Product> invList = Inventory.getInventory().searchSKU(sku);
...
//            labelLocation.setTextSize(10);
//            labelLocation.setText(invList.get(i).getUpc());
...
//        label_location.setText("UPC"); // set the text for the header
